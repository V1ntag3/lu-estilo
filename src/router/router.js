...
import CarrinhoDeProdutosReload from "@/view/CarrinhoDeProdutos.vue";
...
const routes = [
  ...
  },
  {
    ...
    component: CarrinhoDeProdutosReload,
  },
  {
    path: "/cadastroLogin",
    name: "CadastroLogin",
  ...
  },
  {
    path: "/cadastro",
    name: "CadastroPasso3",
    component: CadastroPasso3,
  },
  {
    path: "/finalizar",
    name: "FinalizarCompraEndereco",
    component: FinalizarCompraEndereco,
  },
  {
    path: "/finalizar",
    name: "FinalizarCompraTipoPagamento",
    component: FinalizarCompraTipoPagamento,
  },
  {
    path: "/finalizar",
    name: "FinalizarCompraDinheiro",
    component: FinalizarCompraDinheiro,
  },
  {
    path: "/finalizar",
