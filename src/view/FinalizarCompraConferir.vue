<template>
    ...
    <InformacoesItem :titulo="'Endereço de entrega'" :dados="'Rua coelho resende, 2137 - 64000-200 / Teresina - PI'" />
    <div class="separador"></div>
    <InformacoesItem :titulo="'pagamento na entrega'" :dados="'Cartão de crédito'" />
    <div class="separador"></div>
    <DadosDaCompra />
